package com.batgm.handledata.plugins;
...
public class CommentPlugin extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        document.getRootElement().addElement(new TextElement("<!-- ### 以上代码由jjw + CommentPlugin自动生成, 生成时间: " + (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date()) + " ### -->\n\n\n"));
