...
public class ResultBean implements Serializable {
    ...
    public static  ResultBean newInstance() {
        ResultBean instance = new ResultBean();
        //默认返回信息
     ...
     * @since  2.0
     */
    public static ResultBean  newInstance(Object data) {
        ResultBean instance = new ResultBean();
        //默认返回信息
        instance.code = SUCCESS;
        instance.msg = "success";
     ...
     * @since  2.0
     */
    public static  ResultBean newInstance(int code, String msg, Object data) {
        ResultBean instance = new ResultBean();
        //默认返回信息
        instance.code = code;
        instance.msg = msg;
     ...
     * @since  2.0
     */
    public ResultBean setRemark(String remark){
        this.remark = remark;
        return this;
    }
     ...
     * @since  2.0
     */
    public ResultBean processing(String msg, Object data){
     ...
     * @since  2.0
     */
    public ResultBean processing(String msg){
        this.code = PROCESSING;
        this.msg = msg;
        return this;
    }
